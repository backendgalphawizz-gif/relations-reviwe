...
class PageController extends Controller
{
    ...
    public function about_us(){
        $data = DB::table('static_pages')->where('slug','about_us')->first();
    ...
    public function terms_condition()
    {
        ...
        return view('pages/terms_condition',compact('data'));
    }
    public function updatePages(Request $request)
    {
        ...
        DB::table('static_pages')->where('slug', $request->slug)->update($data);
