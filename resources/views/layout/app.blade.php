    ...
    <nav id="pageheader"class="navbar navbar-expand-lg  theme-nav fixed-top">
        ...
        <div class="container" style="display:initial!important">
            ...
            <a class="navbar-brand" href="{{ url('home') }}#home" [pageScrollOffset]="75" pageScroll><img
                    ...
                    src="https://asthajyotish.com/public/storage/images/AdminLogo1686288970.png" alt="logo"

                    style="height: 50px;width: 50px;vertical-align: middle !important;"><span

                    style="font-size:42px;color:#fff;vertical-align: middle !important;">&nbsp;AsthaJyotish</span></a>
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-12 text-center">
                    ...
                    <p class="copyright">Copyright by AsthaJyotish Powered by Kc Tech</p>
