                    ...
                    <div class="box">
                        <div class="p-5">
                            ...
                            <div class="text-slate-600 dark:text-slate-500 mt-5">
                                ...
                                <div class="flex items-center mt-2 linkText">
                                    Link: {{$banner->link??'-'}}
                                </div>
                            </div>
                        </div>
                        <div
                            ...
                            <a id="editbtn" href="javascript:;"
                                onclick="editbtn({{ $banner->id }} ,'{{ $banner->bannerImage }}' , '{{ $banner->fromDate }}' , '{{ $banner->toDate }}','{{ $banner->bannerTypeId }}','{{ $banner->link }}')"
                            ...
                            <div class="mt-3">
                                ...
                                <div class="grid grid-cols-12 gap-6">
                                    <div class="intro-y col-span-12">
                                        <div>
                                            ...
                                            <input type="file" class="p-2" name="bannerImage" id="bannerImage" onchange="preview()" accept="image/*" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="sm:grid grid-cols gap-2">
                                    ...
                                    <div class="">
                                        ...
                                        <select data-placeholder="Select categories" class="form-control" id="bannerTypeId" name="bannerTypeId">
                                            <option value="" disabled selected required>--Select Banner Type--</option>
                                            @foreach ($bannerType as $bannerTypes)
                                                <option id="bannerTypeId" value={{ $bannerTypes->id }} required>{{ $bannerTypes->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="mt-3">
                                ...
                                <div class="sm:grid grid-cols gap-2">
                                    ...
                                    <div class="input">
                                        <div>
                                            <label for="bannerLink" class="form-label">Banner Link ( Optional )</label>
                                            <input type="text" name="link" id="bannerLink" class="form-control" placeholder="Enter Banner Link">
                                        </div>
                                    </div>
                                    <div class="">
                                        <label for="post-form-3" class="form-label">Banner Type</label>
...
@section('script')
    ...
    <script type="text/javascript">
        function editbtn($id, $bannerImage, $fromDate, $toDate, $bannerTypeId, $bannerLink) {
