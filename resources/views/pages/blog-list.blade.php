                            ...
                            <div class="dropdown ml-3">
                                ...
                                <div class="dropdown-menu w-40">
                                    <ul class="dropdown-content">
                                        <li>
                                            <a href="{{ route('getBlogById', $blog['id']) }}" class="dropdown-item" data-tw-dismiss="dropdown">
                                        ...
                                        <li>
                                            <a id="editbtn" href="javascript:;"
                                                ...
                                                onclick="showEditor()" class="dropdown-item" data-tw-dismiss="dropdown" data-tw-target="#edit-modal" 
                                        ...
                                        <li>
                                            <a id="editbtn" href="javascript:;" onclick="deletebtn({{ $blog['id'] }})"
                                                class="dropdown-item" data-tw-dismiss="dropdown" data-tw-target="#delete-confirmation-modal"
                                            ...
                                            <div class="input mt-2 sm:mt-0">
                                                <div>
                                                    ...
                                                    <input type="date" id="postedOn" name="postedOn"
                                                        ...
                                                        aria-describedby="input-group-3" min="{{ date('Y-m-d') }}">
                                                </div>
                                            </div>
                                            <div class="input mt-2 sm:mt-0">
                                                <div>
        ...
        jQuery(function() {
            jQuery('#edit-form').submit(function(e) {
                ...
                jQuery.ajax({
                    ...
                    error: function (jqxhr, errorText, errthrow) {
                        spinner.hide()
                        if(jqxhr.responseJSON.error) {
                            jQuery.each(jqxhr.responseJSON.error, function (ind, elm) { 
                                toastr.error(elm[0]??'Something went wrong')
                            });
                        }
                    }
                });
        ...
        jQuery(function() {
            jQuery('#add-form').submit(function(e) {
                ...
                jQuery.ajax({
                    ...
                    error: function (jqxhr, errorText, errthrow) {
                        spinner.hide()
                        console.log('jqxhr.responseJSON.error ------------ ', jqxhr.responseJSON.error)
                        if(jqxhr.responseJSON.error) {
                            jQuery.each(jqxhr.responseJSON.error, function (ind, elm) { 
                                toastr.error(elm[0]??'Something went wrong')
                            });
