...
@section('subhead')
    ...
    <title>Relationship Revive in News</title>
...
@section('subcontent')
    ...
    <div class="intro-y flex flex-col sm:flex-row items-center mt-8">
        ...
        <h2 class="text-lg font-medium mr-auto">Relationship Revive News</h2>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h2 class="font-medium text-base mr-auto">Add Relation Revive News</h2>
                ...
                <form id="add-form"method="POST" enctype="multipart/form-data">
                    ...
                    <div id="input" class="p-5">
                        ...
                        <div class="preview">
                            ...
                            <div class="mt-5"><button class="btn btn-primary shadow-md mr-2">Add Relation Revive News</button>
    ...
    <div id="edit-modal" class="modal" tabindex="-1" aria-hidden="true">
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h2 class="font-medium text-base mr-auto">Edit Relation Revive News</h2>
                    <button type="button" class="btn btn-danger" data-tw-dismiss="modal">Close</button>
                </div>
