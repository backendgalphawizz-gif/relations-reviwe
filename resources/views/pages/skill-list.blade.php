...
@section('subcontent')
    ...
    <a href="javascript:;" data-tw-toggle="modal" data-tw-target="#add-skill" class="d-inline mt-10 btn btn-primary shadow-md mr-2 addbtn">Add Skill</a>
    <div class="grid grid-cols-12 gap-6"><div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2"></div></div>
    ...
    <div id="edit-modal" class="modal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{ route('editSkillApi') }}" method="POST" enctype="multipart/form-data" id="edit-skill">
                    @csrf
                                ...
                                <div class="sm:grid grid-cols gap-2">
                                    <div class="input">
                                        <div>
                                            ...
                                            <input type="text" name="name" id="id" class="form-control" placeholder="Name" required onkeypress="return Validate(event);">
                                        </div>
                                    </div>
                                </div>
                            </div>
...
@section('script')
    <script type="text/javascript">
        ...
        jQuery('#edit-skill').submit(function(e) {
            e.preventDefault()
            var name = $("#name").val();

            jQuery.ajax({
                type: 'POST',
                url: "{{ route('editSkillApi') }}",
                data: {
                    name: name
                },
